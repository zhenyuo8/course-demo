...
if($return!='' &&( $return==1 ||  $return==2)){
    ...
    <p class="tishi_tit">直接购买</p>
    <p class="login_sy_cont">'.$msg.'</p>
	</div><div class="footer">京ICP备05007539号-10  版权所有：用友超客网络科技有限公司  2013-2015</div>
';
	echo $output;
	$_POST = array();
	exit;
...
function mailto($nickname, $address, $id, $activation_code,$data,$account)
{
	...
	*/
	 ...
	 $body .= '<p><strong><font color="red">'.$data['company'].'</font>申请企业空间购买</strong></p>';
...
if($_POST['act']=='send_mail'){
	...
	$return = mailto('雷婷蓉', 'ltr@yonyou.com', 1, '123',$data,$mailConfig);
	echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">';	   
...
<input type="hidden"  name="act" value="send_mail">
    ...
    <dl class="login_sy_shury">
		<dt>请确保您的公司名称、邮箱地址和联系电话正确，我们会尽快联系您。</dt>
		<dd class="clearfix">
			<div class="fl zw01">
				<p>姓名：</p>
		...
		<dd><input type="submit" value="提交" onClick="return check_submit();" class="zbtn zbtn_blue"></dd>
	</dl>
    </form>
</div>
...
<footer class="footer_footer">
	<div class="w1000 clearfix footer_footer_in">
		<div class="fl w01 clearfix">
			<span class="dt"><i class="icons_footer01"></i></span>
			<span class="dd">
				<i>客服热线</i>
				<i>4006-815-456</i>
			</span>
		</div>
		<a class="fl w02 clearfix" href="mailto:upservice@yonyou.com">
			 <span class="dt"><i class="icons_footer02"></i></span>
			 <span class="dd">
				<i>客服邮箱</i>
				<i>upservice@yonyou.com</i>
			</span>
		</a>
		<a class="fr w03 clearfix" href="http://chat.looyu.com/chat/chat/p.do?c=53518&amp;f=121982&amp;g=87496" target="_blank">
			 <span class="dt"><i class="icons_footer03"></i></span>
			 <span class="dd">
				<i>在线客服</i>
				<i>为您答疑解惑 >></i>
			</span>
	...
	<div class="w1000">京ICP备05007539号-10 版权所有：用友超客网络科技有限公司 2013-2015</div>
</footer>
</body>
</html>
